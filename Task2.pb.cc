...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Task2_2eproto[3];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_Task2_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_Task2_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Task2_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::Task2::FullName, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::Task2::FullName, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Task2::FullName, name_),
  PROTOBUF_FIELD_OFFSET(::Task2::FullName, surname_),
  PROTOBUF_FIELD_OFFSET(::Task2::FullName, patronymic_),
  ~0u,
  ~0u,
  0,
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Task2::Student, name_),
  PROTOBUF_FIELD_OFFSET(::Task2::Student, grades_),
  PROTOBUF_FIELD_OFFSET(::Task2::Student, avg_score_),
  ~0u,  // no _has_bits_
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 8, sizeof(::Task2::FullName)},
  { 11, -1, sizeof(::Task2::Student)},
  { 19, -1, sizeof(::Task2::StudentsGroup)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::Task2::_FullName_default_instance_),
...
const char descriptor_table_protodef_Task2_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\013Task2.proto\022\005Task2\"Q\n\010FullName\022\014\n\004name"
  "\030\001 \001(\t\022\017\n\007surname\030\002 \001(\t\022\027\n\npatronymic\030\003 "
  "\001(\tH\000\210\001\001B\r\n\013_patronymic\"K\n\007Student\022\035\n\004na"
  "me\030\001 \001(\0132\017.Task2.FullName\022\016\n\006grades\030\002 \003("
  "\r\022\021\n\tavg_score\030\003 \001(\001\"1\n\rStudentsGroup\022 \n"
  "\010students\030\001 \003(\0132\016.Task2.Studentb\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Task2_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Task2_2eproto = {
  false, false, 239, descriptor_table_protodef_Task2_2eproto, "Task2.proto", 
  &descriptor_table_Task2_2eproto_once, nullptr, 0, 3,
  schemas, file_default_instances, TableStruct_Task2_2eproto::offsets,
  file_level_metadata_Task2_2eproto, file_level_enum_descriptors_Task2_2eproto, file_level_service_descriptors_Task2_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_Task2_2eproto_getter() {
  return &descriptor_table_Task2_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_Task2_2eproto(&descriptor_table_Task2_2eproto);
namespace Task2 {
...
FullName::FullName(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Task2.FullName)
}
FullName::FullName(const FullName& from)
  ...
  // @@protoc_insertion_point(copy_constructor:Task2.FullName)
}
...
FullName::~FullName() {
  // @@protoc_insertion_point(destructor:Task2.FullName)
...
void FullName::Clear() {
// @@protoc_insertion_point(message_clear_start:Task2.FullName)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Task2.FullName.name"));
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Task2.FullName.surname"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Task2.FullName.patronymic"));
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* FullName::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Task2.FullName)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Task2.FullName)
  return target;
}

size_t FullName::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Task2.FullName)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:Task2.FullName)
...
// @@protoc_insertion_point(class_specific_copy_from_start:Task2.FullName)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FullName::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Task2_2eproto_getter, &descriptor_table_Task2_2eproto_once,
      file_level_metadata_Task2_2eproto[0]);
}
...
class Student::_Internal {
 public:
  static const ::Task2::FullName& name(const Student* msg);
};

const ::Task2::FullName&
...
Student::Student(const Student& from)
  ...
  if (from._internal_has_name()) {
    name_ = new ::Task2::FullName(*from.name_);
  } else {
    name_ = nullptr;
  }
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 25)) {
          avg_score_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<double>(ptr);
          ptr += sizeof(double);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Student::_InternalSerialize(
  ...
  // double avg_score = 3;
  if (!(this->_internal_avg_score() <= 0 && this->_internal_avg_score() >= 0)) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(3, this->_internal_avg_score(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:Task2.Student)
  ...
  if (from._internal_has_name()) {
    _internal_mutable_name()->::Task2::FullName::MergeFrom(from._internal_name());
  }
  if (!(from._internal_avg_score() <= 0 && from._internal_avg_score() >= 0)) {
...
::PROTOBUF_NAMESPACE_ID::Metadata Student::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Task2_2eproto_getter, &descriptor_table_Task2_2eproto_once,
      file_level_metadata_Task2_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata StudentsGroup::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_Task2_2eproto_getter, &descriptor_table_Task2_2eproto_once,
      file_level_metadata_Task2_2eproto[2]);
}

// @@protoc_insertion_point(namespace_scope)
}  // namespace Task2
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_NOINLINE ::Task2::FullName* Arena::CreateMaybeMessage< ::Task2::FullName >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Task2::FullName >(arena);
}
